...
# ====== 全局可配置参数（可直接在此处修改） ======
USER_NAME = "kksbddytd"         # 用户名
UUID = "09fe80ab-e31d-42cc-8378-789fbe47c8fb"                     # UUID，留空则自动生成
PORT = 52000                  # Vmess端口，留空或0则自动生成
DOMAIN = "weige.800325.xyz"                   # 域名，留空则自动获取
CF_TOKEN = "cloudflared tunnel run --token eyJhIjoiNzIxYzI1MjgzODI5YWQ2ZWQ4MDBlZWIzYjM1YWQ1NTQiLCJ0IjoiM2U3MmUwYjMtOTRmMC00N2U1LTk2MTAtYzc3Zjk4ZjRmOGZhIiwicyI6IlpHUm1OMlpoTW1FdE9XTTRPUzAwTXpNeExUZ3lPVE10WVdJek1EY3paREUzT1RGaCJ9"                 # Cloudflare Token，留空则用Quick Tunnel
# =========================================
